...
@EnableWebMvc
@Configuration
@ComponentScan(basePackages = { "hmd.config, hmd.controller" }, includeFilters = {
...
public class ServletConfig implements WebMvcConfigurer {
	 ...
	 *
	 * @Bean public MessageSourceAccessor getMessageSourceAccessor(){
	 * ReloadableResourceBundleMessageSource m = messageSource(); return new
